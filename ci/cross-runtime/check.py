...
assert cross["sha256"] == "b6c4bd6051298ca1789c065fdc7285fda623fb72abd8ede0a51f69bfcd5c1755", cross
seed = next(r for r in records if r["name"] == "zig_impl_win-64")
assert seed["build"] == "ba77cf0_1970_67f39b551_0", seed
print("ATTESTED cross package:", cross["url"], cross["sha256"], flush=True)
